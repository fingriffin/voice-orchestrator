...
class ImageNames:
    ...
    FINETUNE = "ghcr.io/fingriffin/voice-finetune:test" # Private
    INFERENCE = "ghcr.io/fingriffin/voice-inference:latest" # Private
    ANALYZE = "ghcr.io/fingriffin/style-bench:test" # Private
...
class Misc:
    ...
    # Nice numbered keys for ordering config artifacts in wandb
    NUMBERED_KEYS = {
        "base_model": "0 base_model",
